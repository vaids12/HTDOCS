...
if(isset($_POST['reset'])){
    ...
    if(isset($_POST['submit']) && ($_POST['number1'] !==0 || $_POST['number2'] !==0 || $_POST['number3'] !==0 || $_POST['number4'] !==0) ){ 
         ...
         if($sum>2){
             ...
             $rezult = "<h3>Įveskite vieną reikšmę!</h3>";
             $color = 'danger';
         }
     } 
?>
                ...
                <div class="card text-center">
                    ...
                    <div class= "card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" >  
                             ...
                             Atstumas metrais: 
                            <input type="number" name="number1"  value ="<?php echo round($metr,4);?>"><br><br>  
    
                            Atstumas kilometrais:
                            <input type="number" name="number2"  value ="<?php echo round($kilometr,4);?>"><br><br>  
                            Atstumas myliomis: 
                            <input type="number" name="number3" value ="<?php echo round($mylia,4);?>" ><br><br> 
                            Atstumas jūrmylėmis: 
                            <input type="number" name="number4"  value ="<?php echo round($jurmylia,4);?>"><br><br> 
